...
public class userLocalServiceWrapper
	 ...
	 */
	@Override
	public com.msic.test.liferay.service.user.model.user adduser(
		com.msic.test.liferay.service.user.model.user user) {
	 ...
	 */
	@Override
	public com.msic.test.liferay.service.user.model.user createuser(
		long userId) {
	 ...
	 */
	@Override
	public com.msic.test.liferay.service.user.model.user deleteuser(long userId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.msic.test.liferay.service.user.model.user deleteuser(
		com.msic.test.liferay.service.user.model.user user) {
	...
	@Override
	public com.msic.test.liferay.service.user.model.user fetchuser(
		long userId) {
	 ...
	 */
	@Override
	public com.msic.test.liferay.service.user.model.user
		fetchuserByUuidAndGroupId(String uuid, long groupId) {
	 ...
	 */
	@Override
	public com.msic.test.liferay.service.user.model.user getuser(long userId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.msic.test.liferay.service.user.model.user
			getuserByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.msic.test.liferay.service.user.model.user>
	 ...
	 */
	@Override
	public com.msic.test.liferay.service.user.model.user updateuser(
		com.msic.test.liferay.service.user.model.user user) {
